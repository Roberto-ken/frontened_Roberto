...
function App() {
  const baseUrl="http://localhost/apiRober/";
  ...
  const peticionPost=async()=>{
    ...
    f.append("estreno", frameworkSeleccionado.estreno);
    ...
    .then(response=>{
      ...
      dataNueva.map(framework=>{
        if(framework.id===frameworkSeleccionado.id){
          ...
          framework.estreno=frameworkSeleccionado.estreno;
    ...
    <Modal isOpen={modalInsertar}>
      ...
      <ModalBody>
        <div className="form-group">
          ...
          <label>Estreno: </label>
          <br />
          <input type="text" className="form-control" name="estreno" onChange={handleChange}/>
          <br />
    ...
    <Modal isOpen={modalEditar}>
      ...
      <ModalBody>
        <div className="form-group">
          ...
          <label>Estreno: </label>
          <br />
          <input type="text" className="form-control" name="estreno" onChange={handleChange} value={frameworkSeleccionado && frameworkSeleccionado.estreno}/>
          <br />
          <label>Direccion: </label>
          <br />
